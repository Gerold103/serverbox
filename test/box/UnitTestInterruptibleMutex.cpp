...
namespace box {
	...
	UnitTestInterruptibleMutexWakeupTwo()
	{
		...
		//
		// One thread takes the mutex and does something, not waiting on the
		// main signal.
		//
		...
		//
		// Another threads tries to enter the mutex, but can't atm. Even the
		// wakeup won't help, because the first thread doesn't sleep on the
		// main signal yet.
		//
