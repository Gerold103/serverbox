...
namespace box {
	...
	public:
		...
		// itself.
		mg::box::AtomicVoidPtr* const myQueue;
	...
	MCQBaseSubQueue::MCQBaseSubQueue(
		...
		, myQueue(new mg::box::AtomicVoidPtr[aSize + 1])
		, mySize(aSize)
		, myConsumerCount(0)
		, myPrev(nullptr)
		, myNext(nullptr)
	...
	{
		myLock.Lock();
		MG_BOX_ASSERT(myConsumerCount.LoadRelaxed() == 0);
