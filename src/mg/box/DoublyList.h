...
namespace box {
	...
	// An intrusive doubly-linked list targeted at API simplicity and memory compactness.
	//
	template<typename T, T* T::*myPrev = &T::myPrev, T* T::*myNext = &T::myNext>
	struct DoublyList
	{
		DoublyList();
		// Can only move, no copy. Elements can't be in 2 lists using the same links.
		DoublyList(
			DoublyList&& aList);
		DoublyList(
			T* aFirst,
		...
		void CutLeftExcluding(
			T* aItem);
		void CutLeftIncluding(
			T* aItem);
		void CutRightExcluding(
			T* aItem);
		void CutRightIncluding(
			T* aItem);
	...
	template<typename T, T* T::*myPrev, T* T::*myNext>
	void
	DoublyList<T, myPrev, myNext>::Insert(
		T* aPrev,
		T* aItem)
	{
		if (aPrev != nullptr)
	...
	template<typename T, T* T::*myPrev, T* T::*myNext>
	void
	DoublyList<T, myPrev, myNext>::CutLeftExcluding(
		T* aItem)
	{
		T* prev = aItem->*myPrev;
		aItem->*myPrev = nullptr;
	...
	template<typename T, T* T::*myPrev, T* T::*myNext>
	void
	DoublyList<T, myPrev, myNext>::CutLeftIncluding(
		T* aItem)
	{
		T* next = aItem->*myNext;
		aItem->*myNext = nullptr;
	...
	template<typename T, T* T::*myPrev, T* T::*myNext>
	void
	DoublyList<T, myPrev, myNext>::CutRightExcluding(
		T* aItem)
	{
		T* next = aItem->*myNext;
		aItem->*myNext = nullptr;
	...
	template<typename T, T* T::*myPrev, T* T::*myNext>
	void
	DoublyList<T, myPrev, myNext>::CutRightIncluding(
		T* aItem)
	{
		T* prev = aItem->*myPrev;
		aItem->*myPrev = nullptr;
